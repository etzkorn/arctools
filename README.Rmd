...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/martakarass/arctools.svg?branch=master)](https://travis-ci.com/martakarass/arctools)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/martakarass/arctools?branch=master&svg=true)](https://ci.appveyor.com/project/martakarass/arctools)
...
`r badger::badge_cran_download("arctools", "grand-total", "blue")`
`r badger::badge_cran_download("arctools", "last-month", "blue")`
<!-- badges: end -->
